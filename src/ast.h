...
public:
    ...
    /** Try to resolve the ambiguous types of TOKEN via TYPE. Remove the decls
     *  in TOKEN that fail to unify with TYPE. If ambiguity is resolved (exactly
     *  one type in TOKEN unify with TYPE), actually unify that type with TYPE,
